...
public class Launcher {
    ...
    public void setFrame(String type){
        ...
        switch(type){
            ...
            case "game":
                ...
                (new Thread(this.gamePanel)).start(); //run() in the background
                break;
            case "end":
    ...
    /** Start winning code to delete and replace by endpanel **/
    public void setEndFrame(String winning_tank){
        this.endPanel.setWinningEndPanel(winning_tank);
        setFrame("end");
    }
    /** End winning code to delete and replace by endpanel **/
